...
def install_skill(harness: str = "claude", *, global_install: bool = False) -> Path:
    """Install the thompson Agent Skill.
    ...
    print(f"thompson skill installed {scope} to:\n{destination}")
    return destination
...
def main():
    ...
    install_parser = subparsers.add_parser(
        "install",
        help="Install thompson components.",
    )
    ...
    skill_install_parser = install_subparsers.add_parser(
        "skill",
        help="Install the thompson Agent Skill.",
    )
    ...
    skill_install_parser.add_argument(
        ...
        default=False,
        help=(
            "Install into the user home directory (~/.claude/skills/thompson/) "
